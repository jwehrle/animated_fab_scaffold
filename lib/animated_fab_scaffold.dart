library animated_fab_scaffold;

import 'package:flutter/gestures.dart';
import 'package:flutter/material.dart';
import 'package:flutter/rendering.dart';

class AnimatedFabScaffold extends StatefulWidget {
  const AnimatedFabScaffold({
    Key? key,
    this.appBar,
    required this.body,
  ...
  ///
  /// Listens for scroll events and triggers an animation in
  ...
  ///
  /// Animates out with Fade and Scale Transitions when scrolling down and
  /// animates in with Fade and Scale Transitions when scrolling up.
  //final AnimatedFloatingActionButton floatingActionButton;
  ...
  @override
  State<StatefulWidget> createState() => AnimatedFabScaffoldState();
}

class AnimatedFabScaffoldState extends State<AnimatedFabScaffold>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: AnimatedFabBody(
        controller: _controller,
        child: widget.body,
      ),
      floatingActionButton: AnimatedFab(
        controller: _controller,
        iconData: widget.fabIconData,
...
class AnimatedFabBody extends StatelessWidget {
  final AnimationController controller;
  final Widget child;

  const AnimatedFabBody({
    Key? key,
    required this.controller,
    required this.child,
  }) : super(key: key);
